...
interface ServiceItem { title: string; text: string; icon: string; link: string }
defineProps<{ title: string; intro: string; items: ServiceItem[] }>()
</script>

<template>
  <section id="uslugi" class="bg-stone">
