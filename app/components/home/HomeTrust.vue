...
// десктопный узор (нода 10355:13032): viewBox расширен влево/вниз (-510, +220),
// чтобы на экранах шире 1280 фигуры продолжались до края окна, а не срезались
// по границе полосы; базовая точка та же — узор 930×420 у левого низа полосы
.pattern-desk {
  display: none;
